...
public class Main {
    public static void main(String args[]){
        ...
        13
        */
        //comment Hi Mr.Zaremba, I noticed that the math functions such as power, squareroot, and trig functions give results in floats. I was wondering if any one of these functions appear in an
        expression would it make the anwser have decimals?
